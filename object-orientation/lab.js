...
class Wizard{
 constructor(name, age, favoriteSpell){
   this.wName= name;
   this.wAge= age;
   this.wFavSpell= favoriteSpell;
 }
 castSpell(){
   console.log(this.wName + " has cast " + this.wFavSpell);
 }
}
const thisWizard = new Wizard("bob", 89, "Ice");
...
// create a new variable called helensInfo. 
